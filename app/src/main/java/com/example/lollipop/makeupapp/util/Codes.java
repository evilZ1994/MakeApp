...
public class Codes {
    ...
    public static final int GALLERY_CROP_REQUEST_CODE = 300;
    public static final int CAMERA_REQUEST_CODE = 400;
    public static final int CAMERA_CROP_REQUEST_CODE = 500;
    ...
    public static final int COMMUNITY_CHECK_POST_REQUEST_CODE = 1100;

    //result codes
    public static final int SIGNATURE_RESULT_CODE = 100;
    public static final int COMMUNITY_POST_RESULT_CODE = 200;
    ...
    public static final int COMMUNITY_CHECK_POST_RESULT_CODE = 1100;
    public static final int COMMUNITY_CHECK_POST_RESULT_OK = 1101;
    public static final int COMMUNITY_CHECK_POST_RESULT_FAIL = 1102;
}
